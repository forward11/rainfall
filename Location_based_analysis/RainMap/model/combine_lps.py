...
# 加载图像
wind_imgs = get_all_files('E:\\rainfall\\Location_based_analysis\\RainMap\\plot\\lps\\wind')
rain_imgs = get_all_files('E:\\rainfall\\Location_based_analysis\\RainMap\\plot\\lps\\rain')
for i in range(len(wind_imgs)):
    ...
    cv2.imwrite('E:\\rainfall\\Location_based_analysis\\RainMap\\plot\\lps\\rain&wind\\'+wind_imgs[i].split('\\')[-1], add_img)
